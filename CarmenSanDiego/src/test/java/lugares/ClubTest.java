...
public class ClubTest {
	...
	public void testPistasCuidador() {
		...
		assertEquals(cl.interrogarOcupante().get(0), "El cuidador Pepito el pistolero dice: Te equivocaste de país, el villano no paso por acá");
	}
	...
	public void testImprimirPistasInformante() {
		...
		assertTrue(cl.interrogarOcupante().size() == 3 || cl.interrogarOcupante().size() == 4);
		assertEquals(cl.interrogarOcupante().get(0), "El informante Anyi Tella Arena dice: ");
