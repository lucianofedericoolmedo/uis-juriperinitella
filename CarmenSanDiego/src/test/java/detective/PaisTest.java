...
public class PaisTest {
	...
	public void testAgregarCaracteristica() {
		assertEquals(argentina.getCaracteristicas().size(), 3);
		argentina.agregarCaracteristica("característica");
		assertEquals(argentina.getCaracteristicas().size(), 4);
	}
