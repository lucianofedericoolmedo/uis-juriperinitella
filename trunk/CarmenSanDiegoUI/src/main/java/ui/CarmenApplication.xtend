...
class CarmenApplication extends Application {
	...
	override createMainWindow() {
		...
		hobbiesRamon.add(new PistaHobbie("Pisar su sombrero"))
		...
		pistasLugarAfg.add(new PistaLugar("Planeaba caminar por Caminito "))
		pistasLugarAfg.add(new PistaLugar("Queria comer Asado"))
		pistasLugarAfg.add(new PistaLugar("Cambio su dinero a pesos"))
		pistasLugarAfg.add(new PistaLugar("Tenia una bandera Celeste y Blanca"))
		pistasLugarAfg.add(new PistaSenia("Le gusta Viajar en moto "))
		pistasLugarAfg.add(new PistaHobbie("Hablar con turistas"))
		pistasLugarAfg.add(new PistaSenia("Cicatriz en la cara"))


		/*Pistas Egipto */
		var List<Pista> pistasLugarEgip = newArrayList
		pistasLugarEgip.add(new PistaLugar("Hablo del islam"))
		pistasLugarEgip.add(new PistaLugar("Queria conocer las montañas Hindu Kush"))
		pistasLugarEgip.add(new PistaLugar("Llevaba una bandera negra, roja y verde"))
		pistasLugarEgip.add(new PistaHobbie("Le gusta Viajar en moto "))
		pistasLugarEgip.add(new PistaHobbie("Cicatriz en la cara "))
		pistasLugarEgip.add(new PistaSenia("Le gusta Viajar en moto "))
		pistasLugarEgip.add(new PistaHobbie("Hablar con turistas"))
		pistasLugarEgip.add(new PistaSenia("Cicatriz en la cara"))

		/*Pistas Argentina */
		var List<Pista> pistasLugarArg = newArrayList
		pistasLugarArg.add(new PistaLugar("Cuidado el villano esta cerca"))
		pistasLugarArg.add(new PistaLugar("El villano esta en el pais"))
		pistasLugarArg.add(new PistaSenia("Cuidado el villano esta cerca"))
		pistasLugarArg.add(new PistaSenia("El villano esta en el pais"))
		...
		lugaresSinVillano.add(new Embajada("Embajada", personajeCuid, pistasSinVillano));
		lugaresSinVillano.add(new Biblioteca("Biblioteca", personajeCuid2, pistasSinVillano));
		lugaresSinVillano.add(new Club("Club ", personajeCuid3, pistasSinVillano))

		/*Lugares Egipto */
		var List<Lugar> lugaresEgipto = newArrayList
		lugaresEgipto.add(new Embajada("Embajada", personajeLugEgip1, pistasLugarEgip));
		lugaresEgipto.add(new Biblioteca("Biblioteca", personajeLugEgip2, pistasLugarEgip));
		lugaresEgipto.add(new Club("Club el faraón", personajeLugEgip3, pistasLugarEgip))
		/*Lugares Afagnistan */
		var List<Lugar> lugaresAfg = newArrayList
		lugaresAfg.add(new Embajada("Embajada", personajeAfg, pistasLugarAfg));
		lugaresAfg.add(new Biblioteca("Biblioteca", personajeAfg2, pistasLugarAfg));
		lugaresAfg.add(new Club("Club ", personajeAfg3, pistasLugarAfg))
		/*Lugares Argentina */
		var List<Lugar> lugaresArg = newArrayList
		lugaresArg.add(new Embajada("Embajada", personajeArg, pistasLugarArg));
		lugaresArg.add(new Biblioteca("Biblioteca", personajeArg2, pistasLugarArg));
		lugaresArg.add(new Club("Club ", gaston, pistasLugarArg))
		...
		caracterArg.add("El obelisco");
		caracterArg.add("Caminito")
		var Pais conexionConAfag3 = new Pais("Argentina", caracterArg, lugaresArg, sinConexion)

		/*Afagnistan*/
		var List<String> caracterAfg = newArrayList
		caracterAfg.add("Desierto enorme");
		caracterAfg.add("Montañas")
		var List<Pais> conexionesAfg = newArrayList
		conexionesAfg.add(conexionConAfag1)
		conexionesAfg.add(conexionConAfag2)
		conexionesAfg.add(conexionConAfag3)
		...
		caracsEgipto.add("mucho calor");
		caracsEgipto.add("pirámides")
		var List<Pais> conexionesEgipto = newArrayList
		conexionesEgipto.add(conexionEgipto1)
		conexionesEgipto.add(conexionEgipto2)
		conexionesEgipto.add(conexionEgipto3)
		var Pais paisInicio = new Pais("Egipto", caracsEgipto, lugaresEgipto, conexionesEgipto)

		/*Paises sistema */
		var List<Pais> paises = newArrayList
		paises.add(conexionConAfag3)
		paises.add(conexionConAfag2)
		paises.add(conexionConAfag1)
		paises.add(paisInicio)
		paises.add(conexionEgipto1)
		paises.add(conexionEgipto2)
		paises.add(conexionEgipto3)
		var List<Pais> recorridoVillano = newArrayList
		recorridoVillano.add(conexionEgipto1)
		recorridoVillano.add(conexionConAfag3)
